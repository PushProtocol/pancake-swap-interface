        ...
        <RowBetween>
          <RowFixed>
            ...
            <QuestionHelper
              text={TranslateString(
                224,
                'The difference between the market price and estimated receiving price due to trade size.'
              )}
            />
          </RowFixed>
        ...
        <RowBetween>
          <RowFixed>
            ...
            <QuestionHelper
              text={TranslateString(
                230,
                'For each trade a 0.2% fee is paid. 0.17% goes to liquidity providers and 0.03% goes to the PushSwap treasury.'
              )}
            />
          </RowFixed>
          <Text fontSize="14px">
